...
// VEINS_VLC_API macro. Allows us to use the same .h files for both building a .dll and linking against it
#if defined(VEINS_VLC_EXPORT)
#define VEINS_VLC_API OPP_DLLEXPORT
#elif defined(VEINS_VLC_IMPORT)
#define VEINS_VLC_API OPP_DLLIMPORT
#else
#define VEINS_VLC_API
#endif
